import type { Invoice, InvoiceLine, Payment, Transaction } from "../domain/finance";
...
export async function updateInvoiceStatus(repository:InvoiceRepository,id:string,status:Invoice["status"]){return repository.update(id,{status})}
