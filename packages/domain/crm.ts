...
export type EstimateLineItem = Readonly<{ id: EntityId; description: string; quantity: number; unitPrice: Money }>;
export type Estimate = Readonly<{ id: EntityId; number: string; leadId?: EntityId; customerId?: EntityId; status: EstimateStatus; validUntil?: string; lineItems: readonly EstimateLineItem[]; taxRateBps: number; subtotal: Money; tax: Money; total: Money; notes?: string; createdAt: ISODateTime; updatedAt: ISODateTime }>;
