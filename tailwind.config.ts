	...
	theme: {
		...
		extend: {
			colors: {
				...
				secondary: { DEFAULT: 'hsl(var(--secondary))', foreground: 'hsl(var(--secondary-foreground))', light: 'hsl(var(--secondary-light))' },
				destructive: { DEFAULT: 'hsl(var(--destructive))', foreground: 'hsl(var(--destructive-foreground))' },
				success: { DEFAULT: 'hsl(var(--success))', foreground: 'hsl(var(--success-foreground))' },
				warning: { DEFAULT: 'hsl(var(--warning))', foreground: 'hsl(var(--warning-foreground))' },
				rose: { DEFAULT: 'hsl(var(--rose))', foreground: 'hsl(var(--rose-foreground))' },
				google: { DEFAULT: 'hsl(var(--brand-google))', foreground: 'hsl(var(--brand-google-foreground))' },
				quickbooks: { DEFAULT: 'hsl(var(--brand-quickbooks))', foreground: 'hsl(var(--brand-quickbooks-foreground))' },
			...
			backgroundImage: { 'gradient-primary': 'var(--gradient-primary)', 'gradient-surface': 'var(--gradient-surface)', 'gradient-hero': 'var(--gradient-hero)' },
