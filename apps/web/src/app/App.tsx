...
const Billing = lazy(() => import("../modules/billing/pages/BillingPage").then(({ Billing }) => ({ default: Billing })));
const Transactions = lazy(() => import("../modules/transactions/pages/TransactionsPage").then(({ Transactions }) => ({ default: Transactions })));
const Communications = lazy(() => import("../modules/communications/pages/CommunicationsPage").then(({ Communications }) => ({ default: Communications })));
const Rules = lazy(() => import("../modules/transactions/pages/RulesPage").then(({ Rules }) => ({ default: Rules })));
const Reports = lazy(() => import("../modules/reports/pages/ReportsPage").then(({ Reports }) => ({ default: Reports })));
const Settings = lazy(() => import("../modules/settings/pages/SettingsPage").then(({ Settings }) => ({ default: Settings })));
const Support = lazy(() => import("../modules/support/pages/SupportPage").then(({ Support }) => ({ default: Support })));
const Payroll = lazy(() => import("../modules/payroll/pages/PayrollPage").then(({ Payroll }) => ({ default: Payroll })));
const SyncLogs = lazy(() => import("../modules/settings/pages/SyncLogsPage").then(({ SyncLogs }) => ({ default: SyncLogs })));
...
const RingCentralCallback = lazy(() => import("../modules/communications/pages/RingCentralCallbackPage"));
const DialpadCallback = lazy(() => import("../modules/communications/pages/DialpadCallbackPage"));
const GoogleCallback = lazy(() => import("../modules/settings/pages/GoogleCallbackPage"));
