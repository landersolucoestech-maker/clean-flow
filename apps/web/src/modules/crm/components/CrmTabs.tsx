...
const tabs = [
  ...
  { label: "Contacts", href: "/crm/contacts", icon: ContactRound, permission: "contacts.view" },
] as const;
      ...
      <div className="grid grid-cols-1 gap-1 sm:grid-cols-3">
        {visibleTabs.map((tab) => (
          <NavLink
            ...
            className={({ isActive }) =>
              cn(
                "flex h-10 items-center justify-center gap-2 rounded-xl px-4 text-sm font-medium text-muted-foreground transition-colors hover:bg-muted hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
