    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <Card className="w-full max-w-md">
        ...
        <CardContent className="text-center">
          ...
          {status === "success" && (
            <p className="text-sm text-muted-foreground mt-2"><T k="literal.communications.esta_janela_fechara_automaticamente.b7a66cfb" /></p>
          )}
          {status === "error" && (
            <p className="text-sm text-muted-foreground mt-2"><T k="literal.communications.voce_pode_fechar_esta_janela_e_tentar_novame.32feae95" /></p>
          )}
        </CardContent>
      </Card>
    </div>
